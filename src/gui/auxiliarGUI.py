...
class Build(object):
    def __init__(self, master):
        self.frmConnect = tk.Frame(master, **common_config)
    ...
    def buildAssistantsOpt(self, master):
        self.lblMainIp = tk.Label(master, text="Qual o ip?", **common_config)
        ...
        self.lblMainPort = tk.Label(master, text="Qual a porta?", **common_config)
#       self.lblAssistants.config()
    ...
    def buildLoadConfiguration(self, master):
        self.btnLoadConf = tk.Button(master, text="Configuração...", **common_config)
